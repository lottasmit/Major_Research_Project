...
# save plot
ggsave("PCA_Ribo_all.png", PCA.all, bg="transparent", width = 10)
...
# select top 1000
hm <- hm[which(rownames(hm) %in% rownames(res) [1:500]),]
...
Volcano_RNA_all
ggsave('Volcano_RNA_all.png', Volcano_RNA_all, bg='transparent', width = 12)
```
